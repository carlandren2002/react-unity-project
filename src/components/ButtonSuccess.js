 ...
 * 
 * A customizable animated button with success styling.
 * 
 * @param {Object} props - Component properties
 * @param {() => void} props.onPress - Function to handle button press
 * @param {string} props.title - Button label text
 * @returns {JSX.Element} The animated success button component
 */
const SuccessButton = ({ onPress, title }) => {
  ...
  const backgroundColor = useDerivedValue(() => 
    withTiming(color.successPrimary, { duration: 100 })
  );
